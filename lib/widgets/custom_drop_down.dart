...
class CustomDropDown extends StatelessWidget {
  ...
  Widget get dropDownWidget => Container(
        ...
        child: DropdownButtonFormField(
          ...
          icon: icon,
          autofocus: autofocus!,
          style: textStyle ?? CustomTextStyles.bodySmallLatoOnError11,
          items: items?.map<DropdownMenuItem<String>>((String value) {
            return DropdownMenuItem<String>(
              ...
              child: Text(
                ...
                style: hintStyle ?? CustomTextStyles.bodySmallLatoOnError11,
              ),
            );
          }).toList(),
  ...
  InputDecoration get decoration => InputDecoration(
        hintText: hintText ?? "",
        hintStyle: hintStyle ?? CustomTextStyles.bodySmallLatoOnError11,
        prefixIcon: prefix,
